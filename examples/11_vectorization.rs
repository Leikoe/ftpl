...
fn main() {
    ...
    println!(
        "  Max Vector Width: {}",
        l_row_major.max_vector_width(&valuation)
    );
    ...
    println!(
        "  Max Vector Width: {}",
        l_transposed.max_vector_width(&valuation)
    );
    ...
    println!(
        "  Max Vector Width: {}",
        l_tiled.max_vector_width(&valuation)
    );
    // Expected: 8
    ...
    let l_complex = Expression::Composition(
        Box::new(r),
        Box::new(Expression::Composition(Box::new(t), Box::new(l_row_major))),
    );

    println!("\nTransposed-Reshaped (Broken Contiguity) [4, 8]:");
    println!(
        "  Max Vector Width: {}",
        l_complex.max_vector_width(&valuation)
    );
